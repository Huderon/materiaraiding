...
[P2 M&F](https://ff14.toolboxgaming.space/?id=043186470764761&preview=1)
[P3 Final Omega](https://ff14.toolboxgaming.space/?id=949384711756761&preview=1)
[P4 Blue Screen](https://ff14.toolboxgaming.space/?id=595188367474761&preview=1)

[P5 Dynamis Delta](https://ff14.toolboxgaming.space/?id=732288275415761&preview=1)
[P5 Dynamis Sigma](https://ff14.toolboxgaming.space/?id=107380954136761&preview=1)
[P5 Dynamis Omega](https://ff14.toolboxgaming.space/?id=078384491946761&preview=1)

[P6 Alpha Omega](https://ff14.toolboxgaming.space/?id=829484027197761&preview=1)

[All TOP Positions](https://ff14.toolboxgaming.space/?id=510586440608761&preview=1)

### PoV Videos
Videos covering clears by different roles.

::: details DPS
<YoutubeEmbed videoId="BKGcoU_Entc" />
:::
::: details Healer
ADD LINK HERE
:::
::: details Tank
<YoutubeEmbed videoId="XHEpxUdz_6Q" />
...
<img src="/images/icons/phys.webp" alt="dmgup" style="height: 40px; float: right">
</div>
...
<img src="/images/icons/pot.webp" alt="pot" style="height: 40px; float: right">
</div>
...
## Phase 1: Omega
[P1 Beetle Toolbox](https://ff14.toolboxgaming.space/?id=758088204654761&preview=1)
...
### Program Loop
Program loop begins with each player being assigned a number from 1 to 4, with two of each across the party. This mechanic requires 4 sets of 2 towers to be soaked in a sequential order **FIX ICONS** that will deal significant damage to the player inside. 

For each set of towers that needs to be soaked, two tethers must be taken by two players and taken away from the towers in the order **FIX ICONS**.
...
## Phase 2: Omega-M & F
[P2 M&F Toolbox](https://ff14.toolboxgaming.space/?id=043186470764761&preview=1)
...
Once the dodge is made, all players must resolve their **Mid/Remote Glitch** by splitting into the previously designated light parties and moving to the West (LP1) and East (LP2) **relative to Omega's Eye**. If **Remote Glitch** ![](/images/icons/remote-glitch.webp) is being solved, the cross and triangle players in Light Party 2 will swap positions.
...
Light Party 1 will always anchor West, and Light Party 2 will either be pushed South for **Mid Glitch** ![](/images/icons/mid-glitch.webp), or East for **Remote Glitch** ![](/images/icons/remote-glitch.webp).
...
The debuffs assigned will target 4 players with **Sniper Cannon Fodder** (spread) ![](/images/icons/sniper.webp), 2 players with **High-powered Sniper Cannon Fodder** (stack) ![](/images/icons/high-power-sniper.webp) and 2 players will not be assigned a debuff.
...
[P3 Final Omega Toolbox](https://ff14.toolboxgaming.space/?id=949384711756761&preview=1)
...
**Cascading Latent Defect** ![](/images/icons/latent cascade.webp)
...
**Latent Performance Defect** ![](/images/icons/latent performance defect.webp)
...
- **Critical Underflow Bug** (aka Red Rot) ![](/images/icons/Red Rot.webp)
- **Critical Performance Bug** (aka Blue Rot) ![](/images/icons/Blue Rot.webp)
- **Critical Overflow Bug** (aka Defamation) ![](/images/icons/Defamation.webp)
- **Critical Synchronization Bug** (aka Stack) ![](/images/icons/Stack (HW).webp)
- **Local Code Smell/Local Regression** (aka Christmas Tether) ![](/images/icons/local regression.webp)
- **Remote Code Smell/Remote Regression** (aka Blue Tether) ![](/images/icons/remote regression.webp)
...
## Phase 4: Blue Screen
[P4 Blue Screen Toolbox](https://ff14.toolboxgaming.space/?id=595188367474761&preview=1)
...
> 
> These AOEs inflict 1 stack of **Quickening Dynamis** ![](/images/icons/quickening-dynamis.webp) to each player.
...
The goal of the entirety of phase 5 is to end the phase with 3 stacks of **Quickening Dynamis** ![](/images/icons/quickening-dynamis.webp) on every player, as this is required to complete phase 6.
...
[P5 Dynamis Delta Toolbox](https://ff14.toolboxgaming.space/?id=732288275415761&preview=1)
...
Much like phase 3, breaking tethers results in a **large raid-wide hit** as well as inflicting **Thrice-come Ruin** ![](/images/icons/Thrice come Ruin.webp) on the party. However if the tether debuffs expire the party is killed. As such, we want to gradually break all 4 throughout the course of the mechanic so that the damage does not kill the party whilst not letting the tethers expire.
...
::: warning 
**Christmas Tether** breaks must be done at the right time. Due to **Twice-come Ruin**  ![](/images/icons/Thrice come Ruin.webp) debuffs from **Monitors** and **Pile Pitch**, the first break must be delayed. However, the first **Christmas Tether Players** can use the tether timer and break their tether at 15s as it will always be safe.

Similarly, the second **Christmas Tether** break can be done at ~2 seconds.
:::

::: info NOTE
If solved correctly, 6 players will have 1 stack of **Quickening Dynamis** ![](/images/icons/quickening-dynamis.webp).
:::

**Omega-M** will then do another **Solar Ray** tank buster before casting:

### Run: Dynamis (Sigma Version)
[P5 Dynamis Sigma Toolbox](https://ff14.toolboxgaming.space/?id=107380954136761&preview=1)
...
::: info NOTE
If solved correctly, 4 players will have 1 stack of **Quickening Dynamis** ![](/images/icons/quickening-dynamis.webp), and 4 players will have 2 stacks of **Quickening Dynamis** ![](/images/icons/quickening-dynamis.webp).
:::
...
[P5 Dynamis Omega Toolbox](https://ff14.toolboxgaming.space/?id=078384491946761&preview=1)

After the initial raid-wide, 4 players are assigned **Hello World** debuffs. Two players are assigned with **First in Line** ![](/images/icons/first-in-line.webp), and two others will be assigned with **Second in Line**. One player from each pair will be assigned **Hello, Distant World** and the other **Hello, Near World**.
...
[Omega Dodges](https://www.youtube.com/playlist?list=PLFRB_87JHX5WmAGqkThmV0laFQurUdoak)
...
The two players that must be hit by the monitor are picked to be players with 2 stacks of **Quickening Dynamis** ![](/images/icons/quickening-dynamis.webp). Players with 2 stacks *and* **Second in Line** take priority for this position. 

If these players are not given the monitor position, they cannot line up for the 2nd Hello World as they will have 3 stacks of **Quickening Dynamis** ![](/images/icons/quickening-dynamis.webp) and will get a 4th from their own **Hello World** debuff, forcing a wipe.
...
::: info NOTE
If solved correctly, 2 players will have 3 stacks of **Quickening Dynamis** ![](/images/icons/quickening-dynamis.webp) and the remaining 6 will have 2 stacks of **Quickening Dynamis** ![](/images/icons/quickening-dynamis.webp).
:::

**Beetle Omega** will then spawn on a random cardinal, and a second and final **Hello World** line up must be formed. The players with **3 stacks** of **Quickening Dynamis** ![](/images/icons/quickening-dynamis.webp) must take two tethers from **Beetle Omega** while the other 6 players position themselves as seen below:

![](/images/239696254-751a990e-660a-40ec-9c3a-2d8e90865b2b.webp)

::: info NOTE
If solved correctly all 8 players will have 3 stacks of **Quickening Dynamis** ![](/images/icons/quickening-dynamis.webp).
:::
...
## Phase 6: Alpha Omega
[P6 Alpha Omega Toolbox](https://ff14.toolboxgaming.space/?id=829484027197761&preview=1)
...
**Alpha Omega** will become targetable and immediately begin casting **Cosmo Memory**, which requires a tank LB3 to survive. Upon taking damage from **Cosmo Memory**, everyone's 3 stacks of **Quickening Dynamis** ![](/images/icons/quickening-dynamis.webp) will be transformed to **Brilliant Dynamis** ![](/images/icons/brilliant-dynamis.webp).

The **Brilliant Dynamis** ![](/images/icons/brilliant-dynamis.webp) buff allows every player to use a LB3 during the phase, as it will refund the gauge upon use. Once this limit break is used, **Brilliant Dynamis** ![](/images/icons/brilliant-dynamis.webp) will turn into **Spark of Dynamis** ![](/images/icons/spark-dynamis.webp). Any player **without** **Brilliant Dynamis** ![](/images/icons/brilliant-dynamis.webp) or **Spark of Dynamis** ![](/images/icons/spark-dynamis.webp) will take lethal damage from any damage the boss inflicts. 

::: warning
**Brilliant Dynamis** ![](/images/icons/brilliant-dynamis.webp) and **Spark of Dynamis** ![](/images/icons/spark-dynamis.webp) buffs are lost upon death so it is imperative players do not die during this phase until the very end.
:::
...
**Plus Pattern**
<YoutubeEmbed videoId="h771DAoI0pI" />
**Box Pattern**
<YoutubeEmbed videoId="M7x5ORZteWE" />
...
### Magic Number
**Alpha Omega** will then cast the first **Magic Number**. Tanks must LB3 this to survive. Shortly after the hit a 6s **Magic Number** ![](/images/icons/magic-number.webp) debuff will be applied to the party, killing the player once the debuff falls off. This debuff is cleansed by a healer LB3.
...
::: info HEALER
Healers should wait for the debuff to actually appear before casting their LB3, as **Magic Number** ![](/images/icons/magic-number.webp) takes a second or two to apply after the initial damage goes out.
:::
